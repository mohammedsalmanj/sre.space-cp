...
# Bolt ⚡ Optimization: Compile graph at module level to avoid ~21ms overhead per request.
# The graph structure is static, so we can safely reuse the compiled instance.
